# CPI Sensitivity: cforest — Forest watersheds, Drought years, Consumptive
# Excludes SWP/CVP-dominated HUC8s (project == 1) to test robustness of main CPI results.
# Addresses R2-1 (inter-HUC8 transfers). Companion to main analysis (1_cforest_..._frstdr_11_24.R).
...
save(rf.con, file = paste0("rf_con_all_huc8_non0_", mtry.num, "_", ntree.num,
                           "_pct_frstdr_11_24_nprj.RData"))

print("con Forest-drought, sensitivity (no SWP/CVP), cforest done")
