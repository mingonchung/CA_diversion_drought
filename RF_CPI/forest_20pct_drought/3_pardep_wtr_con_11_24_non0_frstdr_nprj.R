# CPI Sensitivity Step 3: partial dependence — Forest watersheds, Drought years, Consumptive
...
for (i in num) {
  ...
  write.csv(pd.con,
            paste0("pardep_rf_con_", var.name, "_huc8_6_1000_non0_pct_frstdr_11_24_nprj.csv"),
            row.names = FALSE)
