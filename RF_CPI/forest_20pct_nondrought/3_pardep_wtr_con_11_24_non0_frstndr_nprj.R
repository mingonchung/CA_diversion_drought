# CPI Sensitivity Step 3: partial dependence — Forest watersheds, Non-drought years, Consumptive
...
for (i in num) {
  ...
  write.csv(pd.con,
            paste0("pardep_rf_con_", var.name, "_huc8_6_1000_non0_pct_frstndr_11_24_nprj.csv"),
            row.names = FALSE)
