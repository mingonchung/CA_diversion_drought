...
load(paste0("rf_pw_all_huc8_non0_4_1000_pct_frstndr.RData"))
...
# write.csv
setwd(paste0(input.dir,"output/varimp/frstndr/"))

write.csv(imp.pw.perdf,  paste0("permimp_cond_rf_pw_all_huc8_4_1000_thrld",thrd.name,"_non0_raw_pct_frstndr.csv"), row.names=F)

write.csv(imp.pw.perdf.m.ci,  paste0("permimp_cond_rf_pw_all_huc8_4_1000_thrld",thrd.name,"_non0_pct_frstndr.csv"), row.names=F)

write.csv(imp.pw.df.nm,  paste0("permimp_cond_avg_rf_pw_all_huc8_4_1000_thrld",thrd.name,"_non0_pct_frstndr.csv"), row.names=F)
