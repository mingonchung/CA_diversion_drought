# CPI Step 3: partial dependence — Forest watersheds, Non-drought years, Consumptive (consumtive_diverted)
...
for (i in num) {
  ...
  write.csv(pd.con,
            paste0("pardep_rf_con_", var.name, "_huc8_6_1000_non0_pct_frstndr_11_24.csv"),
            row.names = FALSE)
