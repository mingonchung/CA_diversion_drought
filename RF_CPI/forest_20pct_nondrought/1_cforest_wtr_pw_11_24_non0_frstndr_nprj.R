# CPI Sensitivity: cforest — Forest watersheds, Non-drought years, Hydropower
...
rf.pw <- cforest(
  Power_diverted ~ mng_medhigh_10yr_pct + BurnSev34_10yr_pct +
    ...
    year_wtr + month,  # project removed
  data    = wtr.data.sub,
...
print("pw Forest-non-drought, sensitivity (no SWP/CVP), cforest done")
