# CPI Step 1: cforest — Forest watersheds, Non-drought years, Consumptive (consumtive_diverted)
...
save(rf.con, file = paste0("rf_con_all_huc8_non0_", mtry.num, "_", ntree.num,
                           "_pct_frstndr_11_24.RData"))

print("con Forest-non-drought, cforest done")
