# CPI Step 2: permimp — Forest watersheds, Non-drought years, Consumptive (consumtive_diverted)
...
load(paste0("rf_con_all_huc8_non0_6_1000_pct_frstndr_11_24.RData"))
...
write.csv(imp.con.perdf,
          paste0("permimp_cond_rf_con_all_huc8_6_1000_thrld", thrd.name,
                 "_non0_raw_pct_frstndr_11_24.csv"),
          row.names = FALSE)

write.csv(imp.con.perdf.m.ci,
          paste0("permimp_cond_rf_con_all_huc8_6_1000_thrld", thrd.name,
                 "_non0_pct_frstndr_11_24.csv"),
          row.names = FALSE)
