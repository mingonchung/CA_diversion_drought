...
load(paste0("rf_con_all_huc8_non0_4_1000_pct_nfrstndr.RData")) 
...
for (i in num) {
  ...
  write.csv(pd.con, paste0("pardep_rf_con_",var.name,"_huc8_4_1000_non0_pct_nfrstndr.csv"), row.names=F)
