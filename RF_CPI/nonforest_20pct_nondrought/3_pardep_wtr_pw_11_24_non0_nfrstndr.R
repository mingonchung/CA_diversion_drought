# CPI Step 3: partial dependence — Non-forest watersheds, Non-drought years, Hydropower (Power_diverted)
...
for (i in num) {
  ...
  write.csv(pd.pw,
            paste0("pardep_rf_pw_", var.name, "_huc8_6_1000_non0_pct_nfrstndr_11_24.csv"),
            row.names = FALSE)
