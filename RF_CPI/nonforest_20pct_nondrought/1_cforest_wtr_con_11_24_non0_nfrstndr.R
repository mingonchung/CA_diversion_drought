# CPI Step 1: cforest — Non-forest watersheds, Non-drought years, Consumptive (consumtive_diverted)
...
## Retain only HUC8s that cumulatively diverted >= 1000 AF (consumtive_diverted)
...
save(rf.con, file = paste0("rf_con_all_huc8_non0_", mtry.num, "_", ntree.num,
                           "_pct_nfrstndr_11_24.RData"))

print("con Non-forest-non-drought, cforest done")
