...
load(paste0("rf_con_all_huc8_non0_4_1000_pct_nfrstndr.RData")) # rf.con; rf.con.prj; rf.con.nprj
...
write.csv(imp.con.perdf, paste0("permimp_cond_rf_con_all_huc8_4_1000_thrld",thrd.name,"_non0_raw_pct_nfrstndr.csv"), row.names=F)

write.csv(imp.con.perdf.m.ci, paste0("permimp_cond_rf_con_all_huc8_4_1000_thrld",thrd.name,"_non0_pct_nfrstndr.csv"), row.names=F)

write.csv(imp.con.df.nm, paste0("permimp_cond_avg_rf_con_all_huc8_4_1000_thrld",thrd.name,"_non0_pct_nfrstndr.csv"), row.names=F)
