# CPI Step 3: partial dependence — Non-forest watersheds, Drought years, Consumptive (consumtive_diverted)
...
for (i in num) {
  ...
  setwd(paste0(input.dir, "output/pardep/nfrstdr/"))

  write.csv(pd.con,
            paste0("pardep_rf_con_", var.name, "_huc8_6_1000_non0_pct_nfrstdr_11_24.csv"),
            row.names = FALSE)
